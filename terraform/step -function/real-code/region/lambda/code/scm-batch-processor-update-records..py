...
def lambda_handler(event, context):
    try:
        ...
        batch_id = event['batchId']         # Retrieved from Step Function
...
def create_error(error_message, batch_id="unknown", customer_id="unknown", tenant_id="unknown", deployment="unknown", error_count=0, processed_count=0, error_messages=[]):
